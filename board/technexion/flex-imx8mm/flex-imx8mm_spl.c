...
#define PCA9555_25_I2C_ADDR 0x25
...
int board_fit_config_name_match(const char *name)
{
	...
	if (!i2c_probe(PCA9555_23_I2C_ADDR) && !i2c_probe(PCA9555_25_I2C_ADDR)) {
		if (!strcmp(name, "imx8mm-flex-wizard"))
			return 0;
	} else {
		if (!strcmp(name, "imx8mm-flex-pi"))
			return 0;
	}
...
void board_init_f(ulong dummy)
{
	...
	setup_i2c(EXPANSION_IC_I2C_BUS, CONFIG_SYS_I2C_SPEED, 0x7f, &i2c_pad_info2);
