...
static iomux_v3_cfg_t const ver_det_pads[] = {
	IMX8MM_PAD_SAI5_RXD0_GPIO3_IO21 | MUX_PAD_CTRL(VER_DET_GPIO_PAD_CTRL), /* BOARD ID0 */
	IMX8MM_PAD_SAI5_RXD1_GPIO3_IO22 | MUX_PAD_CTRL(VER_DET_GPIO_PAD_CTRL), /* BOARD ID1 */
	IMX8MM_PAD_SAI5_RXD2_GPIO3_IO23 | MUX_PAD_CTRL(VER_DET_GPIO_PAD_CTRL), /* BOARD ID2 */
	IMX8MM_PAD_SAI5_RXD3_GPIO3_IO24 | MUX_PAD_CTRL(VER_DET_GPIO_PAD_CTRL), /* BOARD ID3 */
	IMX8MM_PAD_SAI5_RXC_GPIO3_IO20  | MUX_PAD_CTRL(VER_DET_GPIO_PAD_CTRL), /* BOARD ID4 */
	IMX8MM_PAD_SAI5_RXFS_GPIO3_IO19 | MUX_PAD_CTRL(VER_DET_GPIO_PAD_CTRL), /* BOARD ID5 */
	IMX8MM_PAD_SAI5_MCLK_GPIO3_IO25 | MUX_PAD_CTRL(VER_DET_GPIO_PAD_CTRL), /* BOARD ID6 */
};
...
static iomux_v3_cfg_t const usdhc2_pads[] = {
	...
	IMX8MM_PAD_SD2_RESET_B_USDHC2_RESET_B | MUX_PAD_CTRL(USDHC_PAD_CTRL),
};
