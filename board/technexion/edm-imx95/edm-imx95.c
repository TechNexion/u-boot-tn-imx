...
const tn_camera_chk_t tn_camera_chk[] = {
	{ 4, 0x48, 0x3020, 0x00, "tevs-csi0" },
	{ 1, 0x48, 0x3020, 0x00, "tevs-csi1" },
	{ 4, 0x48, 0x3020, 0x01, "tevm-csi0" },
	{ 1, 0x48, 0x3020, 0x01, "tevm-csi1" },
	{ 4, 0x2e, 0x3020, 0x00, "vls-gm2-csi0" },
	{ 1, 0x2e, 0x3020, 0x00, "vls-gm2-csi1" },
	{ 4, 0x2e, 0x3020, 0x01, "vlm-gm2-csi0" },
	{ 1, 0x2e, 0x3020, 0x01, "vlm-gm2-csi1" },
};
