...
#ifndef __AXON_IMX93_H
#define __AXON_IMX93_H
...
#define JH_ROOT_DTB    "imx93-axon-root.dtb"
...
#define CFG_EXTRA_ENV_SETTINGS		\
	...
	"loadoverlay=" \
		...
		"for ov in ${dtoverlay}; do " \
			"echo Overlaying ${ov}...; " \
			"fatload mmc ${mmcdev}:${mmcpart} ${fdtovaddr} imx93-axon-${baseboard}-${ov}.dtbo && fdt apply ${fdtovaddr}; " \
		"done\0" \
