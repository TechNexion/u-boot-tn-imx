...
#ifndef __XORE_IMX8MM_H
#define __XORE_IMX8MM_H
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"loadfdt=fatload mmc ${mmcdev}:${mmcpart} ${fdt_addr} ${fdt_file}\0" \
        "checkbaseboard=" \
                "if test ${fdt_file} = imx8mm-xore-wizard.dtb; then " \
        ...
        "loadoverlay=" \
                ...
                "for ov in ${dtoverlay}; do " \
                        "echo Overlaying ${ov}...; " \
                        "fatload mmc ${mmcdev}:${mmcpart} ${fdtovaddr} imx8mq-edm-${baseboard}-${ov}.dtbo && fdt apply ${fdtovaddr}; " \
                "done\0" \
	...
	"fit_overlay=for ov in ${dtoverlay}; do " \
			"echo Overlaying ${ov}...; setenv fitov \"${fitov}#conf@imx8mq-edm-${baseboard}-${ov}.dtbo\"; " \
...
#define CONFIG_SN65DSI84
#endif

#define CONFIG_OF_SYSTEM_SETUP

#if defined(CONFIG_ANDROID_SUPPORT)
#include "xore-imx8mm_android.h"
#endif
#endif
