...
#ifndef __SBC_IMX6DL_CONFIG_H
#define __SBC_IMX6DL_CONFIG_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"setfdt=" \
		"if test -n ${wifi_module} && test ${wifi_module} = qca; then " \
			"setenv fdtfile ${som}-${form}-${wifi_module}.dtb; " \
		"else " \
...
#include "sbc-imx6dl_android_common.h"
#else
#define CONFIG_USBD_HS
#endif /* CONFIG_ANDROID_SUPPORT */

#endif  /* __SBC_IMX6DL_CONFIG_H */
