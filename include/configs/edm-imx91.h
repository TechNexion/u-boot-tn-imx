...
#ifndef __IMX91_EDM_H
#define __IMX91_EDM_H
...
#define JH_ROOT_DTB    "imx91-edm-root.dtb"
...
#define CFG_EXTRA_ENV_SETTINGS		\
	...
	"loadoverlay=" \
		...
		"for ov in ${dtoverlay}; do " \
			"echo Overlaying ${ov}...; " \
			"fatload mmc ${mmcdev}:${mmcpart} ${fdtovaddr} imx91-edm-${baseboard}-${ov}.dtbo && fdt apply ${fdtovaddr}; " \
		"done\0" \
